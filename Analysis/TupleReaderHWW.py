...
class EventInfo(object):
    ...
    def scalefactorHyy(self):
      return self.Branches.SF_Photon[0]*self.Branches.SF_PhotonTrigger[0]
      
    def scalefactorTTbar(self):
      return self.Branches.SF_Ele[0]*self.Branches.SF_Mu[0]*self.Branches.SF_LepTrigger[0]*self.Branches.SF_BTag[0]
      
    def scalefactorSingleTop(self):
        return self.scalefactorTTbar()
    
    def scalefactorWBoson(self):
      return self.Branches.SF_Ele[0]*self.Branches.SF_Mu[0]*self.Branches.SF_LepTrigger[0]
    
    def scalefactorHZZ(self):
      return self.scalefactorWBoson()
      
    def scalefactorHWW(self):
      return self.scalefactorWBoson()
      
    def scalefactorWZDiboson(self):
      return self.scalefactorWBoson()
      
    def scalefactorZZDiboson(self):
      return self.scalefactorWBoson()
      
    def scalefactorZBoson(self):
      return self.scalefactorWBoson()
      
    def scalefactorZPrime(self):
      return self.scalefactorTTbar()
      
    def scalefactorSUSY(self):
      return self.scalefactorWBoson()
      
    def scalefactorZTauTau(self):
        return self.scalefactorWBoson() * self.Branches.SF_Tau[0]
